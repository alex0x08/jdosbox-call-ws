...
public class MicroDouble {
  ...
  private static long set(int newHiPart) {
    return ((((long) newHiPart) << 32));
  }

  private static long setLO(long d) {
    return ((d & 0xFFFFFFFF00000000L));
  }
  ...
  public static final long INV_LN2       = 0x3ff71547652b82feL; //  1.44269504088896338700e+00
  ...
  public static long pow(long d1, long d2) {
    ...
    if (iy > 0x41e00000) { // if |y| > 2**31
      ...
      t1 = setLO(add(add(add(z_h, z_l), DP_HI[k]), t));
