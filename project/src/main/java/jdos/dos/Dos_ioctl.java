...
public class Dos_ioctl {
    static public boolean DOS_IOCTL() {
        ...
        if ((CPU_Regs.reg_eax.low()<4) || (CPU_Regs.reg_eax.low()==0x06) || (CPU_Regs.reg_eax.low()==0x07) || (CPU_Regs.reg_eax.low()==0x0a) || (CPU_Regs.reg_eax.low()==0x0c) || (CPU_Regs.reg_eax.low()==0x10)) {
            ...
            Log.log(LogTypes.LOG_DOSMISC, LogSeverities.LOG_ERROR,"DOS:IOCTL Call "+Integer.toString(CPU_Regs.reg_eax.low(), 16)+" unhandled");
        ...
        case 0x0D:		/* Generic block device request */
            {
                ...
                case 0x66:	/* Volume label */
                    ...
                    break;
                default	:
                    Log.log(LogTypes.LOG_IOCTL,LogSeverities.LOG_ERROR,"DOS:IOCTL Call 0D:"+Integer.toString(CPU_Regs.reg_ecx.low(), 16)+" Drive "+Integer.toString(drive, 16)+" unhandled");
                    Dos.DOS_SetError(Dos.DOSERR_FUNCTION_NUMBER_INVALID);
                    return false;
                }
                return true;
