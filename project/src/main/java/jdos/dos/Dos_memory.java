...
public class Dos_memory {
    ...
    static public void DOS_FreeProcessMemory(/*Bit16u*/int pspseg) {
        ...
        } else if (umb_start!=0xffff) Log.log(LogTypes.LOG_DOSMISC, LogSeverities.LOG_ERROR,"Corrupt UMB chain: "+Integer.toString(umb_start,16));
    ...
    static public boolean DOS_LinkUMBsToMemChain(/*Bit16u*/int linkstate) {
        ...
        /*Bit16u*/int umb_start=Dos.dos_infoblock.GetStartOfUMBChain();
        if (umb_start!=UMB_START_SEG) {
            if (umb_start!=0xffff) Log.log(LogTypes.LOG_DOSMISC,LogSeverities.LOG_ERROR,"Corrupt UMB chain: "+Integer.toString(umb_start,16));
            return false;
        }
    ...
    static public void DOS_SetupMemory() {
        ...
        Memory.real_writeb(ihseg, ihofs,0xFE);	//GRP 4
