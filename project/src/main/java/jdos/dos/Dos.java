...
public class Dos extends Module_base {
            ...
            case 0x33:		/* Extended Break Checking */
                switch (CPU_Regs.reg_eax.low()) {
                    ...
                    case 3: /* Get cpsw */
                        /* Fallthrough */
                    case 4: /* Set cpsw */
                        Log.log(LogTypes.LOG_DOSMISC,LogSeverities.LOG_ERROR,"Someone playing with cpsw "+Integer.toString(CPU_Regs.reg_eax.word(),16));
                        break;
                    ...
                    case 6:											/* Get true version number */
                        ...
                        break;
                    default:
                        Log.log(LogTypes.LOG_DOSMISC,LogSeverities.LOG_ERROR,"Weird 0x33 call "+Integer.toString(CPU_Regs.reg_eax.low(), 16));
                        CPU_Regs.reg_eax.low(0xff);
				        break;
                }
                break;
    ...
    //TODO	Give errors for these functions to see if anyone actually uses this shit-
            ...
            case 0x43:					/* Get/Set file attributes */
            {
                ...
                case 0x01:				/* Set */
                    Log.log(LogTypes.LOG_MISC,LogSeverities.LOG_ERROR,"DOS:Set File Attributes for "+name1+" not supported");
                    ...
                    break;
                default:
                    Log.log(LogTypes.LOG_MISC,LogSeverities.LOG_ERROR,"DOS:0x43:Illegal subfunction "+Integer.toString(CPU_Regs.reg_eax.low(),16));
            ...
            case 0x4b:					/* EXEC Load and/or execute program */
                {
                    String name1 = Memory.MEM_StrCopy(CPU_Regs.reg_dsPhys.dword+CPU_Regs.reg_edx.word(),256);
                    Log.log(LogTypes.LOG_EXEC,LogSeverities.LOG_ERROR,"Execute "+name1+" "+CPU_Regs.reg_eax.low());
    ...
    //And will any game ever use this :)
            ...
            case 0x57:					/* Get/Set File's Date and Time */
                if (CPU_Regs.reg_eax.low()==0x00) {
                    ...
                    Log.log(LogTypes.LOG_DOSMISC,LogSeverities.LOG_ERROR,"DOS:57:Unsupported subtion "+Integer.toString(CPU_Regs.reg_eax.low(),16));
                }
                break;
            case 0x58:					/* Get/Set Memory allocation strategy */
                ...
                case 3:					/* Set UMB Link Status */
                    ...
                    break;
                default:
                    Log.log(LogTypes.LOG_DOSMISC,LogSeverities.LOG_ERROR,"DOS:58:Not Supported Set//Get memory allocation call "+Integer.toString(CPU_Regs.reg_eax.low(),16));
                    CPU_Regs.reg_eax.word(1);
                    Callback.CALLBACK_SCF(true);
                }
                break;
            ...
            case 0x65:					/* Get extented country information and a lot of other useless shit*/
                { /* Todo maybe fully support this for now we set it standard for USA */
                    Log.log(LogTypes.LOG_DOSMISC,LogSeverities.LOG_ERROR,"DOS:65:Extended country information call "+Integer.toString(CPU_Regs.reg_eax.word(),16));
            ...
            default:
                Log.log(LogTypes.LOG_DOSMISC,LogSeverities.LOG_ERROR,"DOS:Unhandled call "+Integer.toString(CPU_Regs.reg_eax.high(), 16)+" al="+Integer.toString(CPU_Regs.reg_eax.low(), 16)+". Set al to default of 0");
   ...
   // private static Dos test;
    ...
    public static final Section.SectionFunction DOS_ShutDown = section -> {
 //       test=null;
    ...
    public Dos(Section configuration) {
        super(configuration);
        Callback[] callback = new Callback[7];
    ...
    public static final Section.SectionFunction DOS_Init = section -> {
        new Dos(section);
        /* shutdown function */
