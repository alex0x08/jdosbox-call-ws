...
public class Drive_fat extends Dos_Drive {
   static private final int FAT12 = 0;
    ...
    private String getEntryName(String fullname) {
        ...
        return f.exists() ? f.getName() : null;
    }
    ...
    public Drive_fat(String sysFilename, /*Bit32u*/long bytesector, /*Bit32u*/long cylsector, /*Bit32u*/long headscyl, /*Bit32u*/long cylinders /*Bit32u*/) {
