...
// 22     };
    ...
    static private class CMscdex {
        ...
        int AddDrive(/*Bit16u*/int _drive, String physicalPath, /*Bit8u*/ShortRef subUnit)
        {
            ...
            case 0x00: {
                Log.log(LogTypes.LOG_MISC, LogSeverities.LOG_ERROR,"MSCDEX: Mounting physical cdrom not supported: "+physicalPath);
...
//        #endif
        ...
        switch (ioctl_fct) {
            ...
            case 0x01 :{/* Get current position */
                        ...
                        if (addr_mode==0) {			// HSG
                            ...
                            if (frames<150) Log.log(LogTypes.LOG_MISC,LogSeverities.LOG_ERROR, "MSCDEX: Get position: invalid position "+pos.min+":"+pos.sec+":"+pos.fr);
                            ...
                            Log.log(LogTypes.LOG_MISC,LogSeverities.LOG_ERROR, "MSCDEX: Get position: invalid address mode "+Integer.toString(addr_mode,16));
            ...
            default :
                Log.log(LogTypes.LOG_MISC,LogSeverities.LOG_ERROR,"MSCDEX: Unsupported IOCTL INPUT Subfunction "+Integer.toString(ioctl_fct,16));
                        return 0x03;	// invalid function
        }
        return 0x00;	// success
    }
    ...
    //	Log.log(LogTypes.LOG_MISC,LogSeverities.LOG_ERROR,("MSCDEX: IOCTL OUTPUT Subfunction %02X",ioctl_fct);
        switch (ioctl_fct) {
            ...
            case 0x05 :	// load media
                        ...
                        break;
            default	:
                Log.log(LogTypes.LOG_MISC,LogSeverities.LOG_ERROR,"MSCDEX: Unsupported IOCTL OUTPUT Subfunction "+Integer.toString(ioctl_fct,16));
                        return 0x03;	// invalid function
        }
        return 0x00;	// success
    }
        ...
        public /*Bitu*/int call() {
            ...
            switch (funcNr) {
                ...
                case 0x88	:	/* Resume Audio */
                                ...
                                break;
                default		:
                    Log.log(LogTypes.LOG_MISC,LogSeverities.LOG_ERROR,"MSCDEX: Unsupported Driver Request "+Integer.toString(funcNr,16));
                                break;
    ...
    //							CPU_Regs.reg_ax = error;	// return code
            ...
            case 0x1508: {	// read sectors
                            /*Bit32u*/long sector = ((long) CPU_Regs.reg_esi.word() <<16)+CPU_Regs.reg_edi.word();
        ...
        Log.log(LogTypes.LOG_MISC,LogSeverities.LOG_ERROR,"MSCDEX: Unknwon call : "+Integer.toString(CPU_Regs.reg_eax.word(),16));
        return true;
    };
