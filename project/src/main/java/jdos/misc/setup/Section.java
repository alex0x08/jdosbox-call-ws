...
public abstract class Section {
    ...
    private final Vector<Function_wrapper> initfunctions = new Vector<>();
    private final Vector<Function_wrapper> destroyfunction = new Vector<>();
    ...
    public void ExecuteInit(boolean initall) {
        for (int i=0;i<initfunctions.size();i++) {
            Function_wrapper f = initfunctions.elementAt(i);
    ...
    public void ExecuteDestroy(boolean destroyall) {
        for (int i=0;i<destroyfunction.size();i++) {
            Function_wrapper f = destroyfunction.elementAt(i);
