...
public class VGA_tseng {
    ...
    private static class SVGA_ET4K_DATA {
        public final /*Bit8u*/boolean extensionsEnabled = true;
    ...
    // expect other bits to be preserved.
        ...
        public final /*Bitu*/int[] clockFreq=new int[16];
        public /*Bitu*/int biosMode;
    }

    static final SVGA_ET4K_DATA et4k = new SVGA_ET4K_DATA();
...
//            return et4k.store_##port##_##index;
    ...
    static private final VGA.tWritePort write_p3d5_et4k = (reg, val, iolen) -> {
    ...
    /*Bitu*//*Bitu*//*Bitu*/
    static private final VGA.tReadPort read_p3d5_et4k = (reg, iolen) -> {
        if (!et4k.extensionsEnabled && reg!=0x33)
            return 0x0;
        switch(reg) {
            case 0x31:
    ...
    /*Bitu*//*Bitu*//*Bitu*/
    static private final VGA.tWritePort write_p3c5_et4k = (reg, val, iolen) -> {
        switch(reg) {
        /*
    ...
    /*Bitu*//*Bitu*//*Bitu*/
    static private final VGA.tReadPort read_p3c5_et4k = (reg, iolen) -> {
        switch(reg) {
            case 0x06:
    ...
    */
    static private final IoHandler.IO_WriteHandler io_write_p3cd_et4k = new IoHandler.IO_WriteHandler() {
    ...
    /*Bitu*//*Bitu*//*Bitu*/
    static private final VGA.tWritePort write_p3cd_et4k = (reg, val, iolen) -> {
    ...
    /*Bitu*//*Bitu*//*Bitu*/
    static private final IoHandler.IO_ReadHandler read_p3cd_et4k = (port, iolen) -> (VGA.vga.svga.bank_read<<4)|VGA.vga.svga.bank_write;

    /*Bitu*//*Bitu*//*Bitu*/
    static private final VGA.tWritePort write_p3c0_et4k = (reg, val, iolen) -> {
        switch(reg) {
    ...
    /*Bitu*//*Bitu*//*Bitu*/
    static private final VGA.tReadPort read_p3c1_et4k = (reg, iolen) -> {
        switch(reg) {
            case 0x16:
    ...
    */
    ...
    /*Bitu*/
    private static final VGA.tFinishSetMode FinishSetMode_ET4K = (crtc_base, modeData) -> {
        ...
        if (modeData.modeNo > 0x13) {
            ...
            for (/*Bitu*/int i=0; i<16; i++) {
                /*Bits*//*Bits*/
                int cdiff=Math.abs(target-et4k.clockFreq[i]);
                if (cdiff < dist) {
                    best = i;
                    dist = cdiff;
                }
    ...
    static private final VGA.tDetermineMode DetermineMode_ET4K = () -> {
    ...
    /*Bitu*//*Bitu*/
    static private final VGA.tSetClock SetClock_ET4K = (which, target) -> {
        et4k.clockFreq[which]=1000*target;
        VGA.VGA_StartResize();
    };

    /*Bitu*/
    static private final VGA.tGetClock GetClock_ET4K = () -> et4k.clockFreq[get_clock_index_et4k()];

    /*Bitu*/
    static private final VGA.tAcceptsMode AcceptsMode_ET4K = modeNo -> {
    ...
    // expect other /*Bits*/int to be preserved.
        ...
        public final /*Bitu*/int[] clockFreq = new int[8];
        public /*Bitu*/int biosMode;
    }

    static private final SVGA_ET3K_DATA et3k = new SVGA_ET3K_DATA();
...
//            return et3k.store_##port##_##index;
    ...
    /*Bitu*//*Bitu*//*Bitu*/
    static private final VGA.tWritePort write_p3d5_et3k = (reg, val, iolen) -> {
        switch(reg) {
    ...
    /*Bitu*//*Bitu*//*Bitu*/
    static private final VGA.tReadPort read_p3d5_et3k = (reg, iolen) -> {
        switch(reg) {
        case 0x1b:
    ...
    /*Bitu*//*Bitu*//*Bitu*/
    static private final VGA.tWritePort write_p3c5_et3k = (reg, val, iolen) -> {
        switch(reg) {
    ...
    /*Bitu*//*Bitu*//*Bitu*/
    static private final VGA.tReadPort read_p3c5_et3k = (reg, iolen) -> {
        switch(reg) {
        case 0x06:
    ...
    /*
        ...
        */
    static private final IoHandler.IO_WriteHandler write_p3cd_et3k = (port, val, iolen) -> {
    ...
    /*Bitu*//*Bitu*//*Bitu*/
    static private final IoHandler.IO_ReadHandler read_p3cd_et3k = (port, iolen) -> (VGA.vga.svga.bank_read<<3)|VGA.vga.svga.bank_write|((VGA.vga.svga.bank_size==128*1024)?0:0x40);

    /*Bitu*//*Bitu*//*Bitu*/
    static private final VGA.tWritePort write_p3c0_et3k = (reg, val, iolen) -> {
    // See ET4K notes.
        switch(reg) {
        case 0x16:
    ...
    /*Bitu*//*Bitu*//*Bitu*/
    static private final VGA.tReadPort read_p3c1_et3k = (reg, iolen) -> {
        switch(reg) {
        case 0x16:
    ...
    */
    ...
    /*Bitu*/
    static private final VGA.tFinishSetMode FinishSetMode_ET3K = (crtc_base, modeData) -> {
    ...
    static private final VGA.tDetermineMode DetermineMode_ET3K = () -> {
        // Close replica from the base implementation. It will stay here
        // until I figure a way to either distinguish M_VGA and M_LIN8 or
        // merge them.
        if ((VGA.vga.attr.mode_control & 1)!=0) {
    ...
    /*Bitu*//*Bitu*/
    static private final VGA.tSetClock SetClock_ET3K = (which, target) -> {
        et3k.clockFreq[which]=1000*target;
        VGA.VGA_StartResize();
    };

    /*Bitu*/
    static private final VGA.tGetClock GetClock_ET3K = () -> et3k.clockFreq[get_clock_index_et3k()];

    /*Bitu*/
    static private final VGA.tAcceptsMode AcceptsMode_ET3K = mode -> mode <= 0x37 && mode != 0x2f && Int10_modes.VideoModeMemSize(mode) < VGA.vga.vmemsize;
