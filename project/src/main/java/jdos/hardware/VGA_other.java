...
public class VGA_other {
    /*Bitu*//*Bitu*//*Bitu*/
    private static final IoHandler.IO_WriteHandler write_crtc_index_other = (port, val, iolen) -> VGA.vga.other.index=(short)val;

    /*Bitu*//*Bitu*//*Bitu*/
    private static final IoHandler.IO_ReadHandler read_crtc_index_other = (port, iolen) -> VGA.vga.other.index;

    /*Bitu*//*Bitu*//*Bitu*/
    private static final IoHandler.IO_WriteHandler write_crtc_data_other = (port, val, iolen) -> {
    ...
    /*Bitu*//*Bitu*//*Bitu*/
    private static final IoHandler.IO_ReadHandler read_crtc_data_other = (port, iolen) -> {
        switch (VGA.vga.other.index) {
        case 0x00:		//Horizontal total
    ...
    /*Bitu*//*Bitu*//*Bitu*/
    private static final IoHandler.IO_WriteHandler write_lightpen = (port, val, iolen) -> {
        switch (port) {
...
// to match an entry that is generated here.
        ...
        for(/*Bitu*/int i = 0; i < 16;i++) {
            for(/*Bitu*/int j = 0;j < 5;j++) {
                ...
                pixelI = I / 3.0; //I* tvSaturnation / 3.0
                pixelQ = Q / 3.0; //Q* tvSaturnation / 3.0
    ...
    private static final Mapper.MAPPER_Handler IncreaseHue = pressed -> {
        if (!pressed)
            return;
        hue_offset += 5.0;
        update_cga16_color();
    ...
    private static final Mapper.MAPPER_Handler DecreaseHue = pressed -> {
        if (!pressed)
            return;
        hue_offset -= 5.0;
        update_cga16_color();
    ...
    /*Bitu*//*Bitu*//*Bitu*/
    private static final IoHandler.IO_WriteHandler write_cga = (port, val, iolen) -> {
        switch (port) {
        case 0x3d8:
    ...
    /*Bitu*//*Bitu*//*Bitu*/
    private static final IoHandler.IO_WriteHandler write_tandy = (port, val, iolen) -> {
        switch (port) {
        case 0x3d8:
    ...
    /*Bitu*//*Bitu*//*Bitu*/
    private static final IoHandler.IO_WriteHandler write_pcjr = (port, val, iolen) -> {
        switch (port) {
        case 0x3da:
    ...
    private static final Mapper.MAPPER_Handler CycleHercPal = pressed -> {
        if (!pressed) return;
    ...
    /*Bitu*//*Bitu*//*Bitu*/
    private static final IoHandler.IO_WriteHandler write_hercules = (port, val, iolen) -> {
        switch (port) {
        case 0x3b8: {
    ...
    /*Bitu*//*Bitu*//*Bitu*/
    private static final IoHandler.IO_ReadHandler read_herc_status = (port, iolen) -> {
