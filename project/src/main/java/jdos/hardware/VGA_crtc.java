...
public class VGA_crtc {
    /*Bitu*//*Bitu*//*Bitu*/
    public static final IoHandler.IO_WriteHandler vga_write_p3d4 = (port, val, iolen) -> VGA.vga.crtc.index=(short)val;

    /*Bitu*//*Bitu*//*Bitu*/
    public static final IoHandler.IO_ReadHandler vga_read_p3d4 = (port, iolen) -> VGA.vga.crtc.index;

    /*Bitu*//*Bitu*//*Bitu*/
    public static final IoHandler.IO_WriteHandler vga_write_p3d5 = (port, val, iolen) -> {
    ...
    /*Bitu*//*Bitu*//*Bitu*/
    static public final IoHandler.IO_ReadHandler vga_read_p3d5 = (port, iolen) -> {
