...
public class Gus extends Module_base {
    ...
    public Gus(Section configuration) {
        ...
        IO_ReadHandleObject[] readHandler = new IO_ReadHandleObject[8];
        for (int i = 0; i < readHandler.length; i++)
            readHandler[i] = new IoHandler.IO_ReadHandleObject();
        IO_WriteHandleObject[] writeHandler = new IO_WriteHandleObject[9];
        ...
        AutoexecObject[] autoexecline = new AutoexecObject[2];
