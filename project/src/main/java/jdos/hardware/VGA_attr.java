...
public class VGA_attr {
    ...
    /*Bitu*//*Bitu*//*Bitu*/
    private static final IoHandler.IO_ReadHandler read_p3c0 = (port, iolen) -> {
    ...
    /*Bitu*//*Bitu*//*Bitu*/
    private static final IoHandler.IO_WriteHandler write_p3c0 = (port, val, iolen) -> {
        if (!VGA.vga.internal.attrindex) {
            ...
            */
            ...
            case 0x13:	/* Horizontal PEL Panning Register */
                ...
                switch (VGA.vga.mode) {
                case VGA.M_TEXT:
                    if ((val==0x7) && (Dosbox.svgaCard==SVGACards.SVGA_None)) {
                    }
    ...
    /*Bitu*//*Bitu*//*Bitu*/
    private static final IoHandler.IO_ReadHandler read_p3c1 = (port, iolen) -> {
