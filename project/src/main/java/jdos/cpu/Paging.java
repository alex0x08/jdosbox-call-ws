...
//			dirEntryAddr, tableEntryAddr, table_entry.load, wtest);
    ...
    static private class ExceptionPageHandler extends PageHandler {
        ...
        void Exception(/*PhysPt*/int addr, boolean writing) {
            /*PhysPt*/
            int tableaddr = 0;
            if (true) {
            ...
            PAGING_NewPageFault(addr, tableaddr, false, 1 | (writing ? 2 : 0) | (((CPU.cpu.cpl & CPU.cpu.mpl) == 3) ? 4 : 0));
    ...
    static private class NewInitPageHandler extends PageHandler {
        ...
        void InitPage(/*PhysPt*/int lin_addr, boolean writing) {
            /*Bitu*/
            ...
            //initpage_retry:
                while (true) {
                    ...
                    if (dir_entry.block.p==0) {
                        ...
                        PAGING_NewPageFault(lin_addr, dirEntryAddr, false, (writing? 2:0) | (isUser? 4:0));
                        continue; //goto initpage_retry; // TODO maybe E_Exit after a few loops
                    }
                    ...
                    if (table_entry.block.p==0) {
                        ...
                        PAGING_NewPageFault(lin_addr, tableEntryAddr, false, (writing? 2:0) | (isUser? 4:0));
                        continue; //goto initpage_retry;
                    }
                    ...
                    if (fault_table[ft_index]!=0) {
                        ...
                        PAGING_NewPageFault(lin_addr, tableEntryAddr, false, 1 | (writing? 2:0) | (isUser? 4:0));
                        continue; //goto initpage_retry; // unlikely to happen?
                    }
...
//		Log.log(LogTypes.LOG_PAGING,LogSeverities.LOG_NORMAL,"Enabled");
    ...
    public static final Section.SectionFunction PAGING_Init = section -> {
        Paging test = new Paging(section);
        if (section != null)
