...
public class Prefix_none extends StringOp {
    ...
    static public final OP[] ops = new OP[0x400];
            ...
            case 0x03:											/* NEG Eb */
                {
                    ...
                    if (rm >= 0xc0 ) {
                        Flags.lf_var1b(Modrm.GetEArb[rm].get());Flags.lf_resb(-Flags.lf_var1b());
                        Modrm.GetEArb[rm].set(Flags.lf_resb());
                    } else {
                        /*PhysPt*/int eaa=getEaa(rm);Flags.lf_var1b(Memory.mem_readb(eaa));Flags.lf_resb(-Flags.lf_var1b());
            ...
            case 0x03:											/* NEG Ew */
                {
                    ...
                    if (rm >= 0xc0 ) {
                        Flags.lf_var1w(Modrm.GetEArw[rm].word());Flags.lf_resw(-Flags.lf_var1w());
