...
public class Int10 {
 ...
 //   public static final int VGAMEM_GRAPH= 0xA000;
  ...
  //  public static final int VGAMEM_MTEXT= 0xB000;
    ...
    //		reg_ah=0;
        ...
        case 0x10:								/* Palette functions */
            ...
            case 0x1B:							/* PERFORM GRAY-SCALE SUMMING */
                ...
                break;
                default:
                    Log.log(LogTypes.LOG_INT10,LogSeverities.LOG_ERROR,"Function 10:Unhandled EGA/VGA Palette Function "+Integer.toString(CPU_Regs.reg_eax.low(),16));
                break;
            }
            break;
    ...
    /* General */
            case 0x30:/* Get Font Information */
                ...
                case 0x07:	/* alpha alternate 9x16 */
                    ...
                    break;
                default:
                    Log.log(LogTypes.LOG_INT10,LogSeverities.LOG_ERROR,"Function 11:30 Request for font "+Integer.toString(CPU_Regs.reg_ebx.high(),16));
                    break;
                }
                ...
                break;
            default:
                Log.log(LogTypes.LOG_INT10,LogSeverities.LOG_ERROR,"Function 11:Unsupported character generator call "+Integer.toString(CPU_Regs.reg_eax.low(),16));
                break;
            }
            break;
        case 0x12:								/* alternate function select */
            ...
            case 0x30:							/* Select vertical resolution */
                {
                    if (!Dosbox.IS_VGA_ARCH()) break;
                    Log.log(LogTypes.LOG_INT10,LogSeverities.LOG_WARN,"Function 12:Call "+Integer.toString(CPU_Regs.reg_ebx.low(), 16)+" (select vertical resolution)");
            ...
            case 0x32:							/* Video addressing */
                if (!Dosbox.IS_VGA_ARCH()) break;
                Log.log(LogTypes.LOG_INT10,LogSeverities.LOG_ERROR,"Function 12:Call "+Integer.toString(CPU_Regs.reg_ebx.low(), 16)+" not handled");
                if (Dosbox.svgaCard==SVGACards.SVGA_TsengET4K) CPU_Regs.reg_eax.low((CPU_Regs.reg_eax.low() & 1));
        ...
        case 0x1B:								/* functionality State Information */
            ...
            if (CPU_Regs.reg_ebx.word() == 0x0000) {
                ...
                Log.log(LogTypes.LOG_INT10, LogSeverities.LOG_ERROR, "1B:Unhandled call BX " + Integer.toString(CPU_Regs.reg_ebx.word(), 16));
                CPU_Regs.reg_eax.low(0);
            }
            break;
        ...
        case 0x4f:								/* VESA Calls */
            ...
            case 0x05:
                if (CPU_Regs.reg_ebx.high()==0) {				/* Set CPU Window */
                    ...
                    Log.log(LogTypes.LOG_INT10,LogSeverities.LOG_ERROR,"Unhandled VESA Function "+Integer.toString(CPU_Regs.reg_eax.low(), 16)+" Subfunction "+Integer.toString(CPU_Regs.reg_ebx.high(),16));
            ...
            case 0x07:
                ...
                case 0x01:
                {
                    ...
                    break;
                default:
                    Log.log(LogTypes.LOG_INT10,LogSeverities.LOG_ERROR,"Unhandled VESA Function "+Integer.toString(CPU_Regs.reg_eax.low(), 16)+" Subfunction "+Integer.toString(CPU_Regs.reg_ebx.low(),16));
            ...
            default:
                Log.log(LogTypes.LOG_INT10,LogSeverities.LOG_ERROR,"Unhandled VESA Function "+Integer.toString(CPU_Regs.reg_eax.low(),16));
        ...
        case 0xff:
            ...
            break;
        default:
            Log.log(LogTypes.LOG_INT10,LogSeverities.LOG_ERROR,"Function "+Integer.toString(CPU_Regs.reg_eax.word(), 16)+" not supported");
    ...
    public static final Section.SectionFunction INT10_Init = section -> {
        ...
        /*Bitu*/
        int call_10 = Callback.CALLBACK_Allocate();
