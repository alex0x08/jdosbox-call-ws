...
public class Bios_keyboard {
        ...
        //			Callback.CALLBACK_Idle();
            ...
            case 0x03:	/* SET TYPEMATIC RATE AND DELAY */
                if (CPU_Regs.reg_eax.low() == 0x00) { // set default delay and rate
                    ...
                    Log.log(LogTypes.LOG_BIOS, LogSeverities.LOG_ERROR,"INT16:Unhandled Typematic Rate Call "+Integer.toString(CPU_Regs.reg_eax.low(), 16)+" BX="+Integer.toString(CPU_Regs.reg_ebx.word(),16));
                }
                break;
            ...
            case 0x55:
                ...
                break;
            default:
                Log.log(LogTypes.LOG_BIOS,LogSeverities.LOG_ERROR,"INT16:Unhandled call "+Integer.toString(CPU_Regs.reg_eax.high(),16));
                break;
    ...
    public static void BIOS_SetupKeyboard() {
        ...
        /*Bitu*/
        int call_int16 = Callback.CALLBACK_Allocate();
        ...
        int call_irq1 = Callback.CALLBACK_Allocate();
        ...
        if (Dosbox.machine==MachineType.MCH_PCJR) {
            int call_irq6 = Callback.CALLBACK_Allocate();
