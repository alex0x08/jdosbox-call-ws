...
public class Bios_disk {
    ...
    static public class imageDisk  {
        ...
        public imageDisk(FileIO imgFile, String imgName, /*Bit32u*/long imgSizeK, boolean isHardDisk) {
            ...
            sector_size = 512;
            diskimg = imgFile;
            try {diskimg.seek(0);} catch (Exception ignored) {}
            diskname = imgName;
    ...
    static public void updateDPT() {
        ...
        if(imageDiskList[2] != null) {
            ...
            Memory.phys_writeb(dp0physaddr+0x8,(short)((0xc0 | (((imageDiskList[2].heads) > 8)?1: 0))));
    ...
    static private final Callback.Handler INT13_DiskHandler = new Callback.Handler() {
        ...
        public /*Bitu*/int call() {
            ...
            /*Bitu*/int  i,t;
            /*Bit8u*/
            short last_drive = (short) CPU_Regs.reg_edx.low();
    ...
    /* TODO Start the time correctly */
        /*Bitu*/
        int call_int13 = Callback.CALLBACK_Allocate();
