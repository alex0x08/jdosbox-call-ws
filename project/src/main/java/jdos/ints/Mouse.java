...
public class Mouse {
    static private int int74_ret_callback;
    ...
    static public void Mouse_NewVideoMode() {
        ...
        case 0x12:
            ...
            break;
        default:
            Log.log(LogTypes.LOG_MOUSE,LogSeverities.LOG_ERROR,"Unhandled videomode "+Integer.toString(mode, 16)+" on reset");
    ...
    static private final Callback.Handler INT33_Handler = new Callback.Handler() {
        ...
        //	Log.log(LogTypes.LOG_MOUSE,LogSeverities.LOG_NORMAL,"MOUSE: %04X %X %X %d %d",reg_ax,reg_bx,reg_cx,POS_X,POS_Y);
            ...
            case 0x1a:	/* Set mouse sensitivity */
                ...
                Log.log(LogTypes.LOG_MOUSE,LogSeverities.LOG_WARN,"Set sensitivity used with "+CPU_Regs.reg_ebx.word()+" "+CPU_Regs.reg_ecx.word()+" ("+CPU_Regs.reg_edx.word()+")");
                break;
            case 0x1b:	/* Get mouse sensitivity */
                ...
                Log.log(LogTypes.LOG_MOUSE,LogSeverities.LOG_WARN,"Get sensitivity "+CPU_Regs.reg_ebx.word()+" "+CPU_Regs.reg_ecx.word());
                break;
            ...
            case 0x31: /* Get Current Minimum/Maximum virtual coordinates */
                ...
                break;
            default:
                Log.log(LogTypes.LOG_MOUSE,LogSeverities.LOG_ERROR,"Mouse Function "+Integer.toString(CPU_Regs.reg_eax.word(), 16)+" not implemented!");
                break;
            }
            return Callback.CBRET_NONE;
        }
    ...
    public static final Section.SectionFunction MOUSE_Init = new Section.SectionFunction() {
        public void call(Section section) {
            ...
            /*Bitu*/
            int call_int33 = Callback.CALLBACK_Allocate();
        //	/*RealPt*/int i33loc=RealMake(CB_SEG+1,(call_int33*CB_SIZE)-0x10);
            ...
            int call_mouse_bd = Callback.CALLBACK_Allocate();
            ...
            int call_int74 = Callback.CALLBACK_Allocate();
            ...
            /*Bitu*/
            int call_ps2 = Callback.CALLBACK_Allocate();
